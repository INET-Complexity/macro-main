...
class BankParameters(BaseModel):
    ...
    household_consumption_loans_loan_to_income_ratio: float = Field(ge=0, le=1, default=0.5)
    mortgage_loan_to_income_ratio: float = Field(ge=0, le=10, default=3)
    mortgage_loan_to_value_ratio: float = Field(ge=0, le=1.1, default=0.8)
    mortgage_debt_service_to_income_ratio: float = Field(ge=0, le=1, default=0.3)
    household_consumption_loan_maturity: int = Field(ge=0, default=12)
