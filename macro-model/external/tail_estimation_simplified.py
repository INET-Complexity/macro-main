...
def make_plots(
    ...
    if diagn_plots:
        ...
        axes_d[2].scatter(
            [h1],
            [n1_k_amse[np.where(x1_k_arr == h1)]],
            color="#d55e00",
            marker="o",
            edgecolor="black",
            alpha=0.5,
        ...
        axes_d[2].scatter(
            [h2],
            [n2_k_amse[np.where(x2_k_arr == h2)]],
            color="#0072b2",
            marker="o",
            edgecolor="black",
            alpha=0.5,
...
def calculate_tail_exponent(data: np.ndarray) -> float:
    number_of_bins = 30
    r_smooth = 3
    alpha = 0.6
    hsteps = 200
    ...
    eps_stop = 1 - float(len(data[np.where(data <= amse_border)])) / len(data)
    return make_plots(
        data,
        "",
        number_of_bins,
