...
def get_row_industry_data(country_names, exchange_rates, icio_readers, year):
...
def get_country_industry_data(country_name, country_names, exchange_rates, icio_readers, year):
    # Exchange rates
